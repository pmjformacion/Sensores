...
public class SensoresActivity extends Activity implements SensorEventListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/**
		 * Para obtener la lectura de cada uno de los sensores
		 * se añade el siguiente código, ue 
		 */
	...
	/**
	 * Implementación de los métodos 'onAccurracyChanged' y 'onSensorChanged'
	 * de la interfaz 'SensorEventListener'
	 */
	 @Override 
